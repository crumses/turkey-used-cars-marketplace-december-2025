...
| Column  | Description |
|--------|------------|
| brand  | Car brand (e.g., Audi, BMW, Renault) |
| model  | Car model (e.g., A1, A3, Clio) |
| variant | Engine and trim details |
| year   | Model year |
| km     | Mileage (kilometers) |
| color  | Exterior color |
| price  | Listing price (Turkish Lira) |
| city   | City where the car is listed |
## 📈 Data Notes
- Prices are in Turkish Lira (TRY)
